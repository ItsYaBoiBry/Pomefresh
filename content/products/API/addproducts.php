...
if ($conn) {
    $query_add_product = "INSERT INTO products (product_id, product_name, product_description, product_cost,product_price,product_quantity,product_uom,product_weight,product_length,product_width,product_height,remarks,category_id,vendor_id)"
            . " VALUES (NULL, '$getname', '$getdescription', '$getcostprice', '$getretailprice', $getquantity, '$getuom', '$getweight', '$getlength', '$getwidth', '$getheight', '$getremarks', $getcategories, $getvendor);";
