...
if ($conn) {
    if ($getType == "all") {
        $query_get_all = "SELECT SO.*, C.name, SS.status FROM sales_orders SO, customers C, sales_order_status SS WHERE SO.customers_id = C.id AND SO.sales_order_status_id = SS.id;";
